class Generator(BaseGenerator):
    def data(self):
        ...
        while(pvalue<0.03 or pvalue>0.07):
            ...
            if pvalue<.05:
                conclusion="reject"
            context="The claim that more than 55 percent of adults would support protecting abortion access through a state constitutional amendment is NOT supported"
            if conclusion=="reject":
                context="The claim that more than 55 percent of adults would support protecting abortion access through a state constitutional amendment is supported"
        return {
        "p0dec":p0dec,
        "n":n,
        "s":s,
