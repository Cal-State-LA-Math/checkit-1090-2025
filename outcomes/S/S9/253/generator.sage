class Generator(BaseGenerator):
    def data(self):
        CL=choice([90, 95, 99])
        prose="U.S. adults that support banning TikTok"
        claim1="A U.S. senator claims that"
        direction="more than"
        claim2="of Americans support banning TikTok."
        n=randint(4000,5000)
        c=45
        r=uniform(0.60,0.71)
        s=randint(4500,5500)
        ...
        if c/100<LB and direction=="more than":
